...
btn_clear = tk.Button(root, text="❌", command=lambda: clear_field(), width=5, font=("Helvetica", 14))
btn_clear.grid(row=5, column=1)
btn_equal = tk.Button(root, text="✅", command=lambda: evaluate_calculation(), width=5, font=("Helvetica", 14))
